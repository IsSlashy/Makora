          ...
          <div className="flex items-center gap-1 flex-1">
            {['0.05', '0.1', '0.5'].map((amt) => (
              <button
                ...
                style={{
                  borderColor: depositAmount === amt ? '#00E5FF' : '#1a1a1f',
                  color: depositAmount === amt ? '#00E5FF' : '#504a60',
                  background: depositAmount === amt ? '#00E5FF10' : 'transparent',
                }}
              >
                {amt} SOL
              </button>
              ...
              <div key={tx.id} className="flex items-center justify-between py-1 border-t border-cursed/5">
                <div className="flex items-center gap-1.5">
                  <span
                    ...
                    style={{
                      color: tx.type === 'deposit' ? '#22c55e' : tx.type === 'bonus' ? '#00E5FF' : '#ef4444',
                      background: tx.type === 'deposit' ? '#22c55e12' : tx.type === 'bonus' ? '#00E5FF12' : '#ef444412',
                    }}
                  >
                    {tx.type}
                  </span>
